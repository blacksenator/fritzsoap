...
Base of this generation are the service description files (XML) of my FRITZ!Box 7590. That was the easiest and flawless way to transfer the large amount of services, their actions and theit parameters into a generic structure of classes.
